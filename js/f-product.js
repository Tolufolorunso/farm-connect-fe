...
(function () {
    ...
    let id = user["id"];
    let text = localStorage.getItem("farmvestUser").toString()
    ...
    if (userdata) {
        ...
        fetch(`https://farmvestng.herokuapp.com/api/v1/user/farmers/${id}`, {
                method: 'GET',
    ...
    fetch(`https://farmvestng.herokuapp.com/api/v1/products/${id}`, {
            method: 'GET',
            withCredentials: true,
            headers: {
                authorization: token
